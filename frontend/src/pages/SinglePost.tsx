    ...
    <div className="min-h-screen text-gray-800 ">
      ...
      <div className="max-w-4xl mx-auto mt-10">
        ...
        <div className="flex items-center gap-4 mt-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">5 min read • Jan 22, 2025 </p>
          </div>
        </div>
      </div>
      ...
      <main className="w-full max-w-4xl mx-auto mt-5 bg-white">
        ...
        <article className="prose prose-lg text-gray-800 max-w-none">
          ...
          <h2>Subheading</h2>
          <p>
            Cras vitae purus sit amet eros pharetra auctor. Sed nec quam a arcu
            tristique vehicula. Suspendisse eget consectetur purus. Duis sit
            amet semper est.
          </p>
          <blockquote>
